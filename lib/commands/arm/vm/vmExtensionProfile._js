...
__.extend(VMExtensionProfile.prototype, {
  ...
  _generateVMAemWindowsProfile: function(){
    ...
    this._createAemConfiguration('windows');
  ...
  _generateVMAemLinuxProfile: function(){
    ...
    this._createAemConfiguration('linux');

    return this.generateExtensionProfile();
  },

  _createAemConfiguration: function(osType){
    var publicConfig = {
    ...
    if (osType === 'windows')
      publicConfig['wad.uri'] += 'WADPerformanceCountersTable';
